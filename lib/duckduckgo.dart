...
class DuckDuckGo extends StatefulWidget {
  @override
  _DuckDuckGoState createState() => _DuckDuckGoState();
}

class _DuckDuckGoState extends State<DuckDuckGo> {
            ...
            children: <Widget>[
              ...
              Flexible(
                  ...
                  child: Stack(
                    children: <Widget>[
                      WebView(
                        initialUrl: 'http://duckduckgo.com',
                        onPageFinished: (data) {
                          updateLoading(false);
                        },
